...
export default function Home() {
    ...
    const createTree = () => {
        ...
        // Logic to create a Bittree
        router.push(`/generate?handle=${text}`);
    }

    return (
        <main>
            <section className="bg-[#254f1a] min-h-screen grid grid-cols-2 pt-40 pb-20">
                <div className="flex justify-center flex-col ml-[10vw] gap-3">
                    <p className="text-yellow-300 text-7xl font-extrabold">Everything you</p>
                    <p className="text-yellow-300 text-7xl font-extrabold">are. In one,</p>
                    <p className="text-yellow-300 text-7xl font-extrabold">simple link in bio.</p>
                    ...
                    <div className="input flex gap-2">
                        <input
                            ...
                            className="px-2 py-2 focus:outline-green-900 bg-white rounded-lg"
                            type="text"
