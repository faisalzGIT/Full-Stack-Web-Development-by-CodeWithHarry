...
const Navbar = () => {
  return <> 
    <div className='w-full h-[9vh] bg-gradient-to-b from-green-100 to-white flex justify-between items-center px-10 '>
        ...
        <div className="p2">
            <ul className='gap-7 text-green-900 font-semibold  md:flex hidden'>
                ...
                <NavLink to='/login' className='w-17 text-center hover:scale-110 hover:border-x-2 rounded px-1 transition-all-1s duration-200'>Login</NavLink>
            </ul>
        </div>
    </div>
